...
namespace Nekomimi {
    ...
    private:
        ...
        typedef ResultCode (__stdcall *APICloseKana)(int32_t jobID, int32_t useEvent); // useEvent is default to 0
        typedef ResultCode (__stdcall *APIGetKana)(int32_t jobID, char* textBuf, uint32_t lenBuf, uint32_t* size, uint32_t* pos);
        typedef ResultCode (__stdcall *APITextToSpeech)(int32_t* jobID, TJobParam* param, const char* text);
        typedef ResultCode (__stdcall *APICloseSpeech)(int32_t jobID, int32_t useEvent); // useEvent is default to 0
        typedef ResultCode (__stdcall *APIGetData)(int32_t jobID, int16_t* rawBuf, uint32_t lenBuf, uint32_t* size);
